<x-app-layout>
    ...
    <x-slot name="header">
        <x-page-header title="Edit Suppliers Detail">
                ...
                <div class="card-body">
                    <form action="{{route('supplier.update',$supplier)}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control " placeholder="supplier@example.com"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea class="form-control " placeholder="A Few Words.."
                                    name="remark">{{old('remark',$supplier->remark)}}</textarea>
                                @error('remark')
                                <div class="invalid-feedback d-block">{{$message}}</div>
                                @enderror
                            </div>
